...
package org.janusgraph.diskstorage.os.compat;
...
import org.janusgraph.diskstorage.os.ElasticSearchRequest;
import org.janusgraph.diskstorage.indexing.IndexFeatures;

import com.google.common.collect.ImmutableList;
import com.google.common.collect.ImmutableMap;
import org.janusgraph.diskstorage.os.ElasticSearchConstants;
...
public abstract class AbstractESCompat {
    ...
    public Map<String,Object> createTextMapping(String textAnalyzer) {
        final ImmutableMap.Builder builder = ImmutableMap.builder().put(ElasticSearchConstants.ES_TYPE_KEY, "text");
        return (textAnalyzer != null ? builder.put(ElasticSearchConstants.ES_ANALYZER, textAnalyzer) : builder).build();
    }
    ...
    public ImmutableMap.Builder<String, Object> prepareScript(String source) {
        Map<String, Object> script = ImmutableMap.of(ElasticSearchConstants.ES_SOURCE_KEY, source,
            ElasticSearchConstants.ES_LANG_KEY, scriptLang());
        return ImmutableMap.<String, Object>builder().put(ElasticSearchConstants.ES_SCRIPT_KEY, script);
    }

    public ImmutableMap.Builder<String, Object> prepareStoredScript(String scriptId, List<Map<String, Object>> fields) {
        Map<String, Object> script = ImmutableMap.of(ElasticSearchConstants.ES_ID_KEY, scriptId,
            ElasticSearchConstants.ES_PARAMS_KEY, ImmutableMap.of(ElasticSearchConstants.ES_PARAMS_FIELDS_KEY, fields));
        return ImmutableMap.<String, Object>builder().put(ElasticSearchConstants.ES_SCRIPT_KEY, script);
    }
